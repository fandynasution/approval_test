                            ...
                            <tr>
                                <td style="padding: 30px 30px">
                                    ...
                                    <p style="text-align:left; margin-bottom: 15px; margin-top: 0; color: #000000; font-size: 16px; list-style-type: circle;">
                                        ...
                                        <?php $__currentLoopData = $dataArray['order_remarks']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $order_remarks): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($order_remarks !== '' && $order_remarks !== 'EMPTY'): ?>
                                                <?php if(!$hasOrderRemarks): ?>
                                                    <?php
                                                        $hasOrderRemarks = true;
                                                    ?>
                                                <?php endif; ?>
                                                <b><?php echo e($order_remarks); ?></b><br>
                                            <?php endif; ?>
                                            ...
                                            <?php if($supplier_name !== '' && $supplier_name !== 'EMPTY'): ?>
                                                <?php if(!$hasSupplier): ?>
                                                    <?php
                                                        $hasSupplier = true;
                                                    ?>
                                                <?php endif; ?>
                                                <?php echo e($supplier_name); ?><br>
                                            <?php endif; ?>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        With a total amount of <?php echo e($dataArray['curr_cd']); ?> <?php echo e($dataArray['po_amt']); ?><br>
                                        <?php $__currentLoopData = $dataArray['order_remarks']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $order_remarks): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php
                                                $order_no = $dataArray['order_no'][$key] ?? '';
                                            ?>

                                            <?php if($order_no !== '' && $order_no !== 'EMPTY'): ?>
                                                <?php if(!$hasOrder): ?>
                                                    <?php
                                                        $hasOrder = true;
                                                    ?>
                                                <?php endif; ?>
                                                PO no : <?php echo e($order_no); ?><br>
                                            <?php endif; ?>
                                            ...
                                            <?php if($remark !== '' && $remark !== 'EMPTY'): ?>
                                                <?php if(!$hasRemark): ?>
                                                    <?php
                                                        $hasRemark = true;
                                                    ?>
                                                <?php endif; ?>
                                                RF no : <?php echo e($remark); ?><br>
                                            <?php endif; ?>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </p>
                                    </p>
...
</html><?php /**PATH /var/www/html/approval_live/resources/views/email/po/send.blade.php ENDPATH**/ ?>