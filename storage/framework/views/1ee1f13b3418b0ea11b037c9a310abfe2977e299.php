                            ...
                            <tr>
                                <td style="padding: 30px 30px">
                                    ...
                                    <p style="text-align:left; margin-bottom: 15px; margin-top: 0; color: #000000; font-size: 16px; list-style-type: circle;">
                                        <b><?php echo e($dataArray['po_descs']); ?></b><br>
                                        From Supplier : <?php echo e($dataArray['supplier_name']); ?><br>
                                        Quotation No.: <?php echo e($dataArray['po_doc_no']); ?><br>
                                        With a total amount of <?php echo e($dataArray['curr_cd']); ?> <?php echo e($dataArray['total_amt']); ?><br>
                                        RF no : <?php echo e($dataArray['ref_no']); ?><br>
                                    </p>
