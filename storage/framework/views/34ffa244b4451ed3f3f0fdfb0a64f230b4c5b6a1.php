                            ...
                            <tr>
                                <td style="padding: 30px 30px">
                                    ...
                                    <p style="text-align:left; margin-bottom: 15px; margin-top: 0; color: #000000; font-size: 16px; list-style-type: circle;">
                                        <b>Contract No. :<?php echo e($dataArray['contract_desc']); ?></b><br>
                                        With a total amount of <?php echo e($dataArray['curr_cd']); ?> <?php echo e($dataArray['amount']); ?><br>
                                        and Previous Progress amount of <?php echo e($dataArray['curr_cd']); ?> <?php echo e($dataArray['prev_progress_amt']); ?><br>
                                        on Current Progress on : <?php echo e($dataArray['curr_progress']); ?>%<br>
                                        and Previous Progress on : <?php echo e($dataArray['prev_progress']); ?>%<br>
                                        Progress No.: <?php echo e($dataArray['progress_no']); ?><br>
                                        Progress : <?php echo e($dataArray['surveyor']); ?><br>
                                    </p>
                                    ...
                                    <a href="<?php echo e(url('api')); ?>/cmprogress/A/<?php echo e($encryptedData); ?>" style="display: inline-block; font-size: 13px; font-weight: 600; line-height: 20px; text-align: center; text-decoration: none; text-transform: uppercase; padding: 10px 40px; background-color: #1ee0ac; border-radius: 4px; color: #ffffff;">Approve</a>
                                    <a href="<?php echo e(url('api')); ?>/cmprogress/R/<?php echo e($encryptedData); ?>" style="display: inline-block; font-size: 13px; font-weight: 600; line-height: 20px; text-align: center; text-decoration: none; text-transform: uppercase; padding: 10px 40px; background-color: #f4bd0e; border-radius: 4px; color: #ffffff;">Revise</a>
...
</html><?php /**PATH /var/www/html/approval_live/resources/views/email/cmprogress/send.blade.php ENDPATH**/ ?>