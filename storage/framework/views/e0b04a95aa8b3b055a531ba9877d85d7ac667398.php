                        ...
                        <tbody>
                            <tr>
                                <td style="text-align:center;padding: 50px 30px;">
                                    ...
                                    <form id="frmEditor" class="form-horizontal" method="POST" action="<?php echo e(url('/api/pos/getaccess')); ?>" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
...
</html><?php /**PATH /var/www/html/approval_live/resources/views/email/pos/passcheckwithremark2.blade.php ENDPATH**/ ?>