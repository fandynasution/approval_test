                        ...
                        <tbody>
                            <tr>
                                <td style="text-align:center;padding: 50px 30px;">
                                    <img style="width:88px; margin-bottom:24px;" src="<?php echo e(url('public/images/' . $image)); ?>" alt="Verified">
                                    <p><?php echo $Pesan ?></p>
                                </td>
                            </tr>
                        </tbody>
...
</html><?php /**PATH /var/www/html/approval_live/resources/views/email/after.blade.php ENDPATH**/ ?>