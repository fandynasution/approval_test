                            ...
                            <tr>
                                <td style="padding: 30px 30px">
                                    ...
                                    <p style="text-align:left; margin-bottom: 15px; margin-top: 0; color: #000000; font-size: 16px; list-style-type: circle;">
                                        <b><?php echo e($dataArray['rpb_descs']); ?></b><br>
                                        With a total amount of <?php echo e($dataArray['currency_cd']); ?> <?php echo e($dataArray['trx_amt']); ?><br>
                                        Doc No.: <?php echo e($dataArray['hd_doc_no']); ?><br>
                                    </p>
                                    ...
                                    <a href="<?php echo e(config('app.sso_url')); ?>/approval/<?php echo e($dataArray['entity_cd']); ?>/<?php echo e($dataArray['approve_seq']); ?>/<?php echo e($dataArray['level_no']); ?>" style="display: inline-block; font-size: 13px; font-weight: 600; line-height: 20px; text-align: center; text-decoration: none; text-transform: uppercase; padding: 10px 40px; background-color: #1ee0ac; border-radius: 4px; color: #ffffff;">Approve</a>
                                    <a href="<?php echo e(config('app.sso_url')); ?>/revise/<?php echo e($dataArray['entity_cd']); ?>/<?php echo e($dataArray['approve_seq']); ?>/<?php echo e($dataArray['level_no']); ?>" style="display: inline-block; font-size: 13px; font-weight: 600; line-height: 20px; text-align: center; text-decoration: none; text-transform: uppercase; padding: 10px 40px; background-color: #f4bd0e; border-radius: 4px; color: #ffffff;">Revise</a>
                                    <a href="<?php echo e(config('app.sso_url')); ?>/reject/<?php echo e($dataArray['entity_cd']); ?>/<?php echo e($dataArray['approve_seq']); ?>/<?php echo e($dataArray['level_no']); ?>" style="display: inline-block; font-size: 13px; font-weight: 600; line-height: 20px; text-align: center; text-decoration: none; text-transform: uppercase; padding: 10px 40px; background-color: #e85347; border-radius: 4px; color: #ffffff;">Reject</a>
                                    <br>
                                    <p style="text-align:left;margin-bottom: 15px; color: #000000; font-size: 16px;">
...
</html><?php /**PATH /var/www/html/approval_live/resources/views/email/cbrpb/send.blade.php ENDPATH**/ ?>