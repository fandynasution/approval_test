                        ...
                        <tbody>
                            <tr>
                                <td style="padding: 30px 30px">
                                    ...
                                    <a href="<?php echo e(url('api')); ?>/cbppunewvvip/A/<?php echo e($encryptedData); ?>" style="display: inline-block; font-size: 13px; font-weight: 600; line-height: 20px; text-align: center; text-decoration: none; text-transform: uppercase; padding: 10px 40px; background-color: #1ee0ac; border-radius: 4px; color: #ffffff;">Approve</a>
                                    <a href="<?php echo e(url('api')); ?>/cbppunewvvip/R/<?php echo e($encryptedData); ?>" style="display: inline-block; font-size: 13px; font-weight: 600; line-height: 20px; text-align: center; text-decoration: none; text-transform: uppercase; padding: 10px 40px; background-color: #f4bd0e; border-radius: 4px; color: #ffffff;">Revise</a>
                                    <a href="<?php echo e(url('api')); ?>/cbppunewvvip/C/<?php echo e($encryptedData); ?>" style="display: inline-block; font-size: 13px; font-weight: 600; line-height: 20px; text-align: center; text-decoration: none; text-transform: uppercase; padding: 10px 40px; background-color: #e85347; border-radius: 4px; color: #ffffff;">Reject</a>
                                    <br>
                                    <p style="text-align:left;margin-bottom: 15px; color: #000000; font-size: 16px;">
...
</html><?php /**PATH /var/www/html/approval_live/resources/views/email/cbppuvvip/send.blade.php ENDPATH**/ ?>