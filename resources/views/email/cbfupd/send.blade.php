                        ...
                        <tbody>
                            <tr>
                                <td style="padding: 30px 30px">
                                    ...
                                    <a href="http://192.168.1.117:3000/en/approval/{{ $dataArray['approve_id'] }}" style="display: inline-block; font-size: 13px; font-weight: 600; line-height: 20px; text-align: center; text-decoration: none; text-transform: uppercase; padding: 10px 40px; background-color: #1ee0ac; border-radius: 4px; color: #ffffff;">Check SSO</a>
                                    <br>
                                    <p style="text-align:left;margin-bottom: 15px; color: #000000; font-size: 16px;">
